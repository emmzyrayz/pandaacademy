...
export const IntroCon = () => {
  return (
    <div className="flex flex-col w-full h-full items-start justify-center p-[3%] gap-6 max-w-7xl mx-auto">
      {/* Icon Section */}
      ...
      {/* Video Section */}
      <div className="w-full h-full max-w-[800px] mx-auto rounded-lg overflow-hidden shadow-lg">
        <VideoRenderer
